...
void Escena::visualizarGL( ContextoVis & cv )
{
   ...
   if (cv.modo_visu == ModosVisu::lineas) {
...
Escena2::Escena2()
{
    ...
    //objetos.push_back(new MallaRevolPLY("../recursos/plys/peon.ply",10));

    objetos.push_back(new Cilindro(4,10));
    objetos.push_back(new Cono(3,10));
    objetos.push_back(new Esfera(3,10));
    objetos.push_back(new MediaEsfera(2, 10));
...
Escena3::Escena3()
{
    ...
    objetos.push_back(new Construccion());
